...
const char *get_VkFormat_str(VkFormat format)
{
    switch (format)
    {
...
const char *get_VkColorSpaceKHR_str(VkColorSpaceKHR color_space)
{
    switch (color_space)
    {
...
const char *get_VkColorSpaceKHR_str(VkSurfaceTransformFlagBitsKHR transform)
{
    switch (transform)
    {
